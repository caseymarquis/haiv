...
CLI pipeline internals — routing, resolvers, TUI transport. You don't need these for building commands. See [infrastructure/overview.md](infrastructure/overview.md) for the full maps.
