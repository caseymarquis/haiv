...
- haiv_project: Project-specific commands in src/haiv_project/
- haiv_user: User-specific commands in users/{user}/src/haiv_user/
...
class PackageSource(Enum):
    ...
    PROJECT_LOCAL = auto()
    """Local package in src/haiv_project/. Applies to all users."""
    ...
    USER_LOCAL = auto()
    """Local package in users/{user}/src/haiv_user/. Applies to this user only."""
...
def discover_packages_detailed(
    ...
    # PROJECT_LOCAL - src/haiv_project/
    ...
    _add_result(
        PackageSource.PROJECT_LOCAL, "haiv_project", project_paths, skip_reason,
        packages, included, skipped
    )
    ...
    # USER_LOCAL - users/{user}/src/haiv_user/
    if haiv_root is None:
        user_paths = None
        skip_reason = "haiv_root not provided"
    elif user is None:
    ...
    _add_result(
        PackageSource.USER_LOCAL, "haiv_user", user_paths, skip_reason,
        packages, included, skipped
    )
