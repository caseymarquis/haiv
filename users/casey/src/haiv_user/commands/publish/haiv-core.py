"""hv publish haiv-core - Build and publish haiv-core to PyPI."""
...
def define() -> cmd.Def:
    return cmd.Def(
        description="Build and publish haiv-core to PyPI",
        flags=[
...
def execute(ctx: cmd.Ctx) -> None:
    ...
    package_dir = ctx.paths.worktrees_dir / "main" / "haiv-core"
